...
impl Instruction {
    ...
    fn make_addressing_mode(op: u8) -> AddressingMode {
        return match op {
            ...
            0xa6|0xa7|0xc4|0xc5|0xc6|0xc7|0xe4|0xe5|0xe6
            => AddressingMode::ZeroPage,
            0x15|0x16|0x35|0x36|0x55|0x56|0x75|0x76|0x94|0x95|0xb4|0xb5|0xd5|0xd6|0xd7|
            0xf5|0xf6
            => AddressingMode::ZeroPageX,
            0x96|0x97|0xb6|0xb7
            => AddressingMode::ZeroPageY,
            0x0d|0x0e|0x20|0x2c|0x2d|0x2e|0x4c|0x4d|0x4e|0x6d|0x6e|0x8c|0x8d|0x8e|0x8f|
            0xac|0xad|0xae|0xaf|0xcc|0xcd|0xce|0xcf|0xec|0xed|0xee
            => AddressingMode::Absolute,
            0x1d|0x1e|0x3d|0x3e|0x5d|0x5e|0x7d|0x7e|0x9d|0xbc|0xbd|0xdd|0xde|0xdf|0xfd|
            0xfe
            => AddressingMode::AbsoluteX,
            0x19|0x39|0x59|0x79|0x99|0xb9|0xbe|0xbf|0xd9|0xdb|0xf9
            => AddressingMode::AbsoluteY,
            0x6c
            => AddressingMode::Indirect,
            0x01|0x21|0x41|0x61|0x81|0x83|0xa1|0xa3|0xc1|0xc3|0xe1
            => AddressingMode::IndirectX,
            0x11|0x31|0x51|0x71|0x91|0xb1|0xb3|0xd1|0xd3|0xf1
    ...
    fn make_support(op: u8) -> Support {
        return match op {
            ...
            0xb7|0xbf|0xc3|0xc7|0xcb|0xcf|0xd3|0xd7|0xda|0xdb|0xdf|0xfa
            => Support::Illegal,
            _   => Support::Official
        }
    }
