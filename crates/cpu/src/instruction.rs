...
impl Instruction {
    ...
    fn make_addressing_mode(op: u8) -> AddressingMode {
        return match op {
            ...
            0xa6|0xa7|0xc4|0xc5|0xc6|0xc7|0xe4|0xe5|0xe6|0xe7
            ...
            0x19|0x39|0x59|0x79|0x99|0xb9|0xbe|0xbf|0xd9|0xdb|0xf9|0xfb
            => AddressingMode::AbsoluteY,
            0x6c
            => AddressingMode::Indirect,
            0x01|0x21|0x41|0x61|0x81|0x83|0xa1|0xa3|0xc1|0xc3|0xe1|0xe3
            => AddressingMode::IndirectX,
            0x11|0x31|0x51|0x71|0x91|0xb1|0xb3|0xd1|0xd3|0xf1|0xf3
    ...
    fn make_support(op: u8) -> Support {
        return match op {
            ...
            0xb7|0xbf|0xc3|0xc7|0xcb|0xcf|0xd3|0xd7|0xda|0xdb|0xdf|0xfa|0xe3|0xe7|0xef|
            0xf3|0xf7|0xfb|0xff
            => Support::Illegal,
            _   => Support::Official
        }
