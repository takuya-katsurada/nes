...
mod tests {
    ...
    # [test]
    fn execute_slo_instruction()
    {
        let mut cpu = super::Cpu::default();
        let mut mem = memory::Memory::default();

        for param in [
            (0x10, 0x01, 0x12, 0x02, false, false, false),
            (0x01, 0x40, 0x81, 0x80, false, false, true),
        ] {
            cpu.a  = param.0;
            cpu.pc = 0x0000u16;
